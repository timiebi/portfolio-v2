  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 50% at 50% -10%, color-mix(in oklab, var(--highlight) 8%, transparent) 0%, transparent 60%),
            radial-gradient(ellipse 55% 45% at 85% 100%, color-mix(in oklab, var(--highlight) 5%, transparent) 0%, transparent 55%)
          `,
        }}
      />
    </div>
